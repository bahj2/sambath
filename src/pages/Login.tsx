    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-primary items-center justify-center p-12 relative overflow-hidden">
        <div className="absolute inset-0 opacity-20">
          <div className="absolute top-1/4 right-1/4 w-96 h-96 bg-white rounded-full blur-3xl animate-float" />
          <div className="absolute bottom-1/4 left-1/4 w-64 h-64 bg-white rounded-full blur-3xl animate-float" style={{ animationDelay: "2s" }} />
        </div>
        ...
        <div className="relative z-10 text-center text-primary-foreground max-w-lg">
          ...
          <p className="text-lg opacity-90">
            Continue translating your videos with our AI-powered dubbing platform.
          </p>
        </div>
      </div>
