        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-8">
            ...
            <p className="text-muted-foreground">
              Start translating videos in minutes. No credit card required.
            </p>
          </div>
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-primary items-center justify-center p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center text-primary-foreground max-w-lg">
          <div className="mb-8 inline-block">
            <img src={bathAiLogo} alt="Bath AI" className="w-24 h-24 object-contain mx-auto" />
          </div>
          <h2 className="text-4xl font-bold mb-4">Translate videos to any language</h2>
          <p className="text-lg opacity-90">
            Powered by AI. Automatic speech recognition, translation, and voice synthesis – all in one seamless workflow.
          </p>
          ...
          <div className="mt-12 grid grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <div className="text-sm opacity-80">Videos Translated</div>
            </div>
            <div className="text-center">
